...
class CDbLogicMFCSqliteImpl : public CDbLogic
{
public:
    CDbLogicMFCSqliteImpl();
    virtual ~CDbLogicMFCSqliteImpl();
...
private:
    ...
    // 私有赋值操作符，拒绝赋值
    CDbLogicMFCSqliteImpl& operator=(const CDbLogicMFCSqliteImpl& r )
    {
        return *this;
    }
    // 私有拷贝构造函数，拒绝拷贝构造
    CDbLogicMFCSqliteImpl( CDbLogicMFCSqliteImpl& r ) : CDbLogic("")
    {
    }
};
